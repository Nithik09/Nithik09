...
# 👋 Hi, I'm Nithik Roshan Devaraj  
### 🤖 AI Engineer (Automation) | AI • ML • DL • NLP • Full-Stack Engineering  
📍 Chicago, IL, United States  

<a href="https://www.linkedin.com/in/nithik-roshan-devaraj-8783192aa" target="_blank">
  <img src="https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin"/>
</a>
<a href="mailto:nithikroshan06@gmail.com">
...
## 🚀 About Me
I’m an **AI Engineer focused on Automation**, building intelligent, product-ready systems that reduce manual effort, enable real-time decision-making, and scale reliably in production environments.

- 🎓 **M.S. in Artificial Intelligence** — Illinois Institute of Technology (Dec 2025)  
- 🤖 Strong focus on **AI-driven automation, LLM systems, and decision engines**  
- 🧠 Hands-on experience across **ML, Deep Learning, NLP, and Software Engineering**  
- ⚙️ Build **end-to-end AI systems** (data → model → API → deployment)  
- 🤝 Open to **Fall 2025 Internships / Co-ops / AI Engineer roles**

---

## 🧠 Core Strengths
- Automation-first AI system design  
- LLM-powered applications (RAG, orchestration, APIs)  
- Real-time ML inference & decisioning  
- Product-oriented thinking (usability, latency, reliability)  
- Clean, scalable, production-ready engineering  
...
- Applied ML / NLP / Deep Learning  
- Product-focused AI engineering  
- Internships, co-ops, or collaboration  
